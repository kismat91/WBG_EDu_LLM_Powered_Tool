...
HUGGINGFACE_API_KEY = os.environ.get("HUGGINGFACE_API_KEY", "your_your_hf_token_here")
GROQ_API_KEY = os.environ.get("GROQ_API_KEY", "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")
