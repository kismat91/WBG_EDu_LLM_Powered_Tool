...
os.environ["GROQ_API_KEY"] = "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"
...
if pdf_file and csv_file:
    ...
    #headings = ["A. PDO", "PROJECT DESCRIPTION", "Annex 2: Detailed Project Description"]
    headings = [
...
#]
    #headings = [
    #r"A\.\s*Project Development Objective",
    #r"B\.\s*Project Components",
    #r"C\.\s*Project Beneficiaries"
#]
